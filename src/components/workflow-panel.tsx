...
function PhaseIllustration({ phase }: { phase: (typeof workflowSteps)[number]["title"] }) {
  ...
  if (phase === "Understand") {
    return <svg {...commonProps}><circle cx="38" cy="47" r="11" /><path d="M20 80v-4c0-10 8-18 18-18s18 8 18 18v4H20Z" /><path d="M56 48h27M237 48h27" strokeDasharray="4 5" /><circle cx="70" cy="48" r="3" fill="currentColor" stroke="none" /><circle cx="250" cy="48" r="3" fill="currentColor" stroke="none" /><circle cx="282" cy="47" r="11" /><path d="M264 80v-4c0-10 8-18 18-18s18 8 18 18v4h-36Z" /><text x="24" y="99" fill="currentColor" stroke="none" fontSize="9" opacity=".62">USER</text><text x="251" y="99" fill="currentColor" stroke="none" fontSize="9" opacity=".62">FACILITATOR</text><path d="M89 22h76a7 7 0 0 1 7 7v28a7 7 0 0 1-7 7h-37l-13 11V64H89a7 7 0 0 1-7-7V29a7 7 0 0 1 7-7Z" /><path d="M99 38h42M99 49h29" opacity=".65" /><path d="M151 38h74a7 7 0 0 1 7 7v31a7 7 0 0 1-7 7h-20v11l-13-11h-41a7 7 0 0 1-7-7V45a7 7 0 0 1 7-7Z" /><path d="M181 53c0-6 13-7 13 1 0 6-7 6-7 12" /><circle cx="187" cy="73" r="2.5" fill="currentColor" stroke="none" /><path d="M160 87v34" strokeDasharray="4 5" /><circle cx="160" cy="104" r="3" fill="currentColor" stroke="none" /><path d="m154 116 6 6 6-6" /><rect x="91" y="129" width="138" height="55" rx="7" /><circle cx="120" cy="156" r="18" /><circle cx="120" cy="156" r="10" opacity=".65" /><circle cx="120" cy="156" r="3" fill="currentColor" stroke="none" /><path d="M151 148h56M151 160h43" opacity=".65" /><text x="129" y="207" fill="currentColor" stroke="none" fontSize="11" opacity=".62">CORE NEED</text></svg>;
  }
